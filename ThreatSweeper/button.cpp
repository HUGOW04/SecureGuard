...
Button::Button(float x, float y, std::string id, std::string buttonText, Font* font)
    : x_Pos(x), y_Pos(y), m_ButtonName(id), m_Text(buttonText), m_Font(font)
{
}

void Button::render(GLFWwindow* m_Window, int m_Width, int m_Height)
{
    if (getIsHovering())
